  ...
  return (
    <footer className="flex flex-col items-center justify-between gap-6 px-6 py-10 mt-12 mb-6 border border-gray-300 sm:flex-row rounded-xl">
      ...
      <ul className="flex items-center gap-4">
        <li>
          <a href="mailto:yacineahmaich@gmail.com" target="_blank">
            <span className="sr-only">Email</span>
            <svg
              fill="currentColor"
              className="w-6 h-6 transition-transform fill-gray-600 hover:-translate-y-px hover:scale-105"
              version="1.1"
              id="Capa_1"
	...
	l49.374-39.276V156z"
        ...
        <li>
          <a href="https://twitter.com/yacine_a23" target="_blank">
